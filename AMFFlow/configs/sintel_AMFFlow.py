...
_CN.trainer.canonical_lr = 2.5e-6 #3e-5

_CN.trainer.split_train = False
_CN.trainer.pretrained_lr = 5e-4
_CN.trainer.new_lr = 5e-4

_CN.trainer.pct_start = 0.02
_CN.trainer.adamw_decay = 5e-5
_CN.trainer.clip = 1.0
_CN.trainer.num_steps = 200000
